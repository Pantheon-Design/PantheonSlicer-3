...
#include <algorithm>
// std::regex instead of boost::regex: boost's w32 regex traits fail to compile in this
// translation unit, where a dependency pulls in a stripped-down set of windows headers.
#include <regex>

...
#else // _WIN32
    return wxIcon(Slic3r::var("PantheonSlicer_128px.png"), wxBITMAP_TYPE_PNG);
#endif // _WIN32
}
...
*/
    ...
    case GUI_App::EAppMode::Editor:
        ...
        m_taskbar_icon->SetIcon(wxIcon(Slic3r::var("PantheonSlicer-mac_256px.ico"), wxBITMAP_TYPE_ICO), "PantheonSlicer");
        break;
...
#else
    SetIcon(wxIcon(var("PantheonSlicer_128px.png"), wxBITMAP_TYPE_PNG));
#endif // _WIN32

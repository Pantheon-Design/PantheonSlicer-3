...
void ExtrusionCalibration::create()
{
    ...
    m_btn_bg_green = StateColor(std::pair<wxColour, int>(wxColour(238, 238, 238), StateColor::Disabled), std::pair<wxColour, int>(wxColour(129, 170, 147), StateColor::Pressed), std::pair<wxColour, int>(wxColour(181, 255, 214), StateColor::Hovered),
    ...
    m_button_cali->SetBorderColor({ std::pair<wxColour, int>(wxColour(238, 238, 238), StateColor::Disabled), std::pair<wxColour, int>(wxColour(148, 209, 176), StateColor::Enabled) });
    ...
    m_cali_cancel->SetBorderColor(wxColour(148, 209, 176));
    ...
    m_button_save_result->SetBorderColor(wxColour(148, 209, 176));

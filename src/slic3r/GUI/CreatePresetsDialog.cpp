...
#define SELECT_ALL_OPTION_COLOUR wxColour("#94D1B0")
...
wxBoxSizer *CreatePrinterPresetDialog::create_hot_bed_stl_item(wxWindow *parent)
{
    ...
    StateColor flush_bd_col(std::pair<wxColour, int>(wxColour(148, 209, 176), StateColor::Pressed), std::pair<wxColour, int>(wxColour(148, 209, 176), StateColor::Hovered),

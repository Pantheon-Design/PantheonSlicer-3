...
/*#ifdef __WXOSX__
    ...
    m_top_sizer->Add(m_btn_hide_incompatible_presets, 0, wxALIGN_CENTER_VERTICAL | wxLEFT, 8);
...
void TabPrint::build()
{
    ...
    page = add_options_page(L("Strength"), "custom-gcode_strength"); // ORCA: icon only visible on placeholders
        ...
        optgroup->append_single_option_line("solid_infill_wall_overlap", "strength_settings_infill#solid-infill-wall-overlap");
    ...
    optgroup->append_single_option_line("enable_support", "support_settings_support");
        ...
        optgroup->append_single_option_line("tree_support_low_poly_tree", "support_settings_tree");
...
void TabSLAMaterial::build()
{
    ...
    auto page = add_options_page(L("Dependencies"), "wrench.png");
    auto optgroup = page->new_optgroup(L("Profile dependencies"));

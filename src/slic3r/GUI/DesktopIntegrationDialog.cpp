...
void DesktopIntegrationDialog::perform_desktop_integration()
{
    ...
    for (size_t i = 0; i < target_candidates.size(); ++i) {
        ...
        if (contains_path_dir(target_candidates[i], "images")) {
            ...
            std::string icon_path = GUI::format("%1%/images/PantheonSlicer.png",resources_dir());
            std::string dest_path = GUI::format("%1%/images/%2%PantheonSlicer%3%.png", target_dir_icons, icon_theme_path, version_suffix);

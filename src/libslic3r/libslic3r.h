...
#define SLIC3R_APP_FULL_NAME "Pantheon Slicer"
#define GCODEVIEWER_APP_NAME "PantheoSlicer G-code Viewer"
#define GCODEVIEWER_APP_KEY  "PantheoSlicerGcodeViewer"
#define GCODEVIEWER_BUILD_ID std::string("PantheoSlicer G-code Viewer-") + std::string(SLIC3R_VERSION) + std::string("-RC")

var LangText = {
  en: {
    t1: "Welcome to Pantheon Slicer",
    t2: "Pantheon Slicer will be setup in several steps. Let's start!",
    t3: "User Agreement",
    t4: "Disagree",
    t5: "Agree",
    ...
    t65: "Please be aware that these plugins are not developed or maintained by PantheonSlicer. They should be used at your own discretion and risk.",
  ...
  fr_FR: {
    ...
    t65: "Veuillez noter que ces plugins ne sont pas développés ou maintenus par PantheonSlicer. Ils doivent être utilisés à votre propre discrétion et à vos propres risques.",
  ...
  zh_CN: {
    ...
    t64: "Bambu网络插件",
    t65: "注意：这些插件不是由PantheonSlicer开发或维护的。使用它们需自担风险",
    t66: "强大的远程控制功能",
    t67: "实时视频流",
    t68: "用户数据同步",
    t69: "安装Bambu网络插件",
  ...
  tr_TR: {
    ...
    t65: "Lütfen bu eklentilerin PantheonSlicer tarafından geliştirilmediğini veya bakımının yapılmadığını unutmayın. Kendi takdirinize ve riskinize göre kullanılmalıdırlar.",
  ...
  pl_PL: {
    ...
    t65: "Proszę mieć świadomość, że te wtyczki nie są rozwijane ani utrzymywane przez PantheonSlicer. Powinny być używane na własne ryzyko i z rozwagą.",
  ...
  pt_BR: {
    ...
    t65: "Por favor seja cuidadoso estes plugins não são desenvolvidos ou mantidos por PantheonSlicer. Eles devem ser usados por sua conta e risco.",
